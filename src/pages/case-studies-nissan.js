        ...
        <section id="home" ref={heroRef} className="relative min-h-dvh flex items-center justify-center overflow-hidden quantum-anim hero-section pt-20">
            ...
            <div className="absolute inset-0 z-0">
                <img 
                    ...
                    alt="Nissan Bulgaria Case Study"
            ...
            <div className="pointer-events-none absolute inset-0 z-5 overflow-hidden">
                ...
                {/* Floating Data Dots - Optimized count for performance */}
                <div className="absolute inset-0">
                    {[...Array(5)].map((_, i) => (
                        <div
                            key={`dot-${i}`}
            ...
            <style jsx global>{`
                ...
                @keyframes geometric-float {
                    ...
                    50% { 
                        transform: translate3d(0, -20px, 0) rotate3d(0, 0, 1, 180deg);
                        opacity: 0.4;
                    }
                }
                ...
                .animate-grid-pulse { animation: grid-pulse 7s ease-in-out infinite; }
                ...
                .animate-shape-glow { animation: shape-glow 5s ease-in-out infinite; }
                .animate-inner-pulse { animation: inner-pulse 4s ease-in-out infinite; }
                .animate-connection-pulse { animation: connection-pulse 6s ease-in-out infinite; }
            ...
            {/* Removed breadcrumb for cleaner hero header */}
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-6">
                    <span className="block">Driving High-Quality</span>
                    <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-sky-500">Leads</span>
                    <span className="block">for a Global Leader</span>
                </h1>
                
                <p className="max-w-3xl mx-auto text-lg md:text-xl text-slate-300 leading-relaxed mb-12">
                    How BYLT Media, <span className="text-cyan-300 font-semibold">in collaboration with Marketise Me</span>, transformed Nissan Bulgaria's digital strategy to generate over 2,000 qualified test drive requests through targeted performance marketing and conversion optimization.
                </p>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="text-center mb-20">
                    ...
                    <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto">
                        A strategic approach to transforming Nissan Bulgaria's lead generation through comprehensive campaign optimization and user experience enhancement.
                    </p>
                </div>
...
const ResultsDashboard = () => {
    ...
    const metrics = [
        { key: 'testDrives', title: 'Test Drive Requests', value: 2000, suffix: '+', icon: Car, color: 'text-cyan-400', bgColor: 'bg-cyan-400/10', borderColor: 'border-cyan-400/20' },
        { key: 'conversion', title: 'Landing Page CVR', value: 25, suffix: '%', icon: Target, color: 'text-sky-400', bgColor: 'bg-sky-400/10', borderColor: 'border-sky-400/20' },
        { key: 'socialLeads', title: 'Social Media Leads', value: 1000, suffix: '+', icon: Users, color: 'text-teal-400', bgColor: 'bg-teal-400/10', borderColor: 'border-teal-400/20' },
        { key: 'value', title: 'Monthly Lead Value', value: 45, prefix: '£', suffix: 'k', icon: TrendingUp, color: 'text-emerald-400', bgColor: 'bg-emerald-400/10', borderColor: 'border-emerald-400/20' }
    ];
    ...
    return (
        <div id="results" ref={dashboardRef} className="py-16">
            ...
            <p className="text-lg text-slate-400 text-center mb-12 max-w-2xl mx-auto">Exceptional, measurable results that significantly boosted the sales pipeline.</p>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { title: 'Client', value: 'Nissan Bulgaria', icon: Building },
                            { title: 'Industry', value: 'Automotive', icon: Car },
                            { title: 'Duration', value: '12 Weeks', icon: Clock },
                            { title: 'Team Size', value: '5 Specialists', icon: Users },
                            { title: 'Platforms', value: '3 Channels', icon: Globe }
                        ].map((item, index) => {
                    ...
                    <div className="mt-8 p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-cyan-400/50 transition-all duration-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {[
                                { name: 'Paid Media (Google & Social)', icon: Target },
                                { name: 'Landing Page Design', icon: Code },
                                { name: 'Conversion Rate Optimisation', icon: TrendingUp }
                            ].map((service, index) => {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <div>
                            <p className="text-lg text-slate-300 leading-relaxed mb-6">
                                Nissan Bulgaria aimed to increase qualified test drive leads but struggled with a complex user journey and low conversion rates from their existing digital strategy.
                            </p>
                        ...
                        <div className="grid grid-cols-3 gap-4 text-center">
                            <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-red-400/50 transition-colors">
                                <span className="block text-3xl font-bold text-red-400">2.3%</span>
                                <span className="text-xs text-slate-400 uppercase">Previous CVR</span>
                            </div>
                            <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-red-400/50 transition-colors">
                                <span className="block text-3xl font-bold text-red-400">8</span>
                                <span className="text-xs text-slate-400 uppercase">Form Fields</span>
                            </div>
                            <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-slate-400/50 transition-colors">
                                <span className="block text-3xl font-bold text-slate-300">67%</span>
                                <span className="text-xs text-slate-400 uppercase">Mobile Traffic</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-16 mb-16">
                    ...
                    <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                        Working through our strategic partnership with <span className="text-cyan-400 font-semibold">Marketise Me</span>, we leveraged enhanced targeting capabilities and industry expertise to deliver exceptional results for Nissan Bulgaria's digital transformation:
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            { icon: Target, title: "Targeted Ad Campaigns", text: "Deployed highly-targeted campaigns on Google & Social Media to reach potential buyers with model-specific messaging." },
                            { icon: Code, title: "High-Converting Landing Pages", text: "Designed bespoke, mobile-first landing pages with clear value propositions and simplified lead forms." },
                            { icon: MousePointerClick, title: "Optimised User Journey", text: "Re-architected the ad-click-to-submission path, removing friction to make booking a test drive seamless." }
                        ].map((item, index) => {
                            const Icon = item.icon;
                            return(
                                <div key={item.title} className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-cyan-400/50 hover:bg-slate-700/50 transition-all duration-300 hover:scale-105 group">
    ...
    return (
        <Layout>
            <Head>
                ...
                <meta name="description" content="Discover how BYLT Media, in collaboration with Marketise Me, generated over 2,000 test drive requests for Nissan Bulgaria through a targeted performance marketing strategy." />
                <link rel="icon" href="/favicon.ico" />
                <link rel="canonical" href="https://www.byltmedia.com/case-studies-nissan" />
