...
const CaseStudyHero = () => {
    ...
    const stats = [
        { value: "6", label: "ROAS Achieved", icon: TrendingUp },
        { value: "€97,209", label: "Revenue Generated", icon: DollarSign },
        { value: "2,859", label: "Orders Completed", icon: ShoppingBag },
        { value: "3.72%", label: "Click-Through Rate", icon: Target }
    ];
    ...
    return (
        <section id="home" ref={heroRef} className="relative min-h-dvh flex items-center justify-center overflow-hidden quantum-anim hero-section pt-20">
            ...
            <div className="absolute inset-0 z-0">
                <img 
                    src="/images/casestudy/cska-case-study.webp" 
                    alt="CSKA Sofia 1948 Case Study"
            ...
            {/* Dynamic Sports Data Visualization Animation */}
            <div className="pointer-events-none absolute inset-0 z-20 overflow-hidden">
                ...
                <div className="absolute inset-0" style={{ transform: 'translateZ(0)', willChange: 'transform' }}>
                    ...
                    {[...Array(5)].map((_, i) => (
                        <div
                            key={`bar2-${i}`}
                            className="absolute bg-gradient-to-t from-teal-500 to-sky-400 rounded-t-sm animate-data-bar-alt opacity-60"
                            style={{
                                left: `${15 + i * 14}%`,
                                top: '20%',
                                width: '3px',
                ...
                <div className="absolute top-1/4 left-1/4 w-40 h-40" style={{ transform: 'translateZ(0)', contain: 'layout style paint' }}>
                    <div className="relative w-full h-full animate-orbit-slow" style={{ willChange: 'transform' }}>
                        ...
                        <div className="absolute top-1/4 right-1/4 w-2 h-2 bg-sky-400 rounded-full animate-pulse shadow-lg shadow-sky-400/50" style={{animationDelay: '1.5s', transform: 'translateZ(0)', willChange: 'transform, opacity'}}></div>
                    </div>
                </div>
                ...
                <div className="absolute top-1/3 right-1/4 w-32 h-32" style={{ transform: 'translateZ(0)', contain: 'layout style paint' }}>
                    <div className="relative w-full h-full animate-orbit-fast" style={{ willChange: 'transform' }}>
                        <div className="absolute top-0 left-1/2 w-3 h-3 bg-sky-400 rounded-full animate-pulse shadow-lg shadow-sky-400/50" style={{animationDelay: '0.2s', transform: 'translate3d(-50%, 0, 0)', willChange: 'transform, opacity'}}></div>
                ...
                <div className="absolute top-2/3 left-1/3 animate-geometric-float opacity-30" style={{animationDelay: '2s'}}>
                    <svg width="40" height="40" viewBox="0 0 40 40" className="text-sky-400">
                ...
                <svg className="absolute inset-0 w-full h-full opacity-25">
                    <g className="animate-connection-pulse">
                        ...
                        <line x1="80%" y1="50%" x2="20%" y2="25%" stroke="currentColor" strokeWidth="1" className="text-sky-400" strokeDasharray="4,8" />
                    </g>
                </svg>
            ...
            <div className="relative z-30 text-center text-white max-w-6xl mx-auto px-4">
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-6">
                    <span className="block">Growing Sales & Fanbase</span>
                    <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-sky-500">for CSKA Sofia 1948</span>
                </h1>
                
                <p className="max-w-3xl mx-auto text-lg md:text-xl text-slate-300 leading-relaxed mb-12">
                    How BYLT Media, <span className="text-cyan-300 font-semibold">in collaboration with Marketise Me</span>, helped CSKA Sofia 1948 achieve exceptional growth in merchandise and ticket sales through strategic digital marketing, reaching ROAS 6 and significantly expanding their fanbase.
                </p>
            ...
            <div onClick={() => document.querySelector('#process')?.scrollIntoView({ behavior: 'smooth' })} className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2 cursor-pointer group">
                ...
                <span className="text-xs text-cyan-300 opacity-0 group-hover:opacity-100 transition-all duration-300" style={{ transform: 'translate3d(0, 8px, 0)', willChange: 'transform, opacity' }}>
                    See Our Strategy
                </span>
            </div>
        </section>
    ...
    const processSteps = [
        {
            ...
            subtitle: "Month 1",
            description: "Comprehensive analysis of football club digital marketing trends and CSKA 1948's current online presence.",
            icon: <Search className="w-6 h-6" />,
            details: [
                "Analyzed leading football clubs' social media strategies worldwide",
                "Identified low online engagement with younger, tech-savvy audiences",
                "Studied competitive entertainment market with many options",
                "Assessed limited visibility in digital channels",
                "Established baseline metrics for sales and fan engagement"
            ],
            metrics: ["Market research", "Audience analysis", "Digital assessment"]
        },
        {
            step: "02",
            title: "Strategic Planning", 
            subtitle: "Month 1-2",
            description: "Development of comprehensive digital strategy focusing on multi-platform engagement and sales optimization.",
            icon: <Target className="w-6 h-6" />,
            details: [
                "Focused strategy on Facebook, Instagram, YouTube, and Google Ads",
                "Planned behind-the-scenes videos and player interviews content",
                "Designed influencer partnership programs",
                "Created seasonal advertising campaigns for different products",
                "Developed media planning and content creation framework"
            ],
            metrics: ["4 platform strategy", "Content planning", "Influencer partnerships"]
        },
        {
            step: "03",
            title: "Execution & Implementation",
            subtitle: "Month 2-6", 
            description: "Full-scale execution of digital campaigns with engaging content and optimized user journey.",
            icon: <Rocket className="w-6 h-6" />,
            details: [
                "Launched targeted campaigns across all planned platforms",
                "Created engaging behind-the-scenes and player interview content",
                "Implemented influencer partnerships for broader reach",
                "Optimized website user journey and marketing funnel",
                "Executed seasonal product campaigns with precise targeting"
            ],
            metrics: ["Multi-platform execution", "Content creation", "Funnel optimization"]
        },
        {
            step: "04",
            title: "Outstanding Results",
            subtitle: "Month 6 Results",
            description: "Exceptional performance achieving ROAS 6 with significant improvements in sales and fan engagement.",
            icon: <Trophy className="w-6 h-6" />,
            details: [
                "Achieved remarkable ROAS of 6 with €97,209 revenue",
                "Generated 2,859 orders with €5.6 cost per acquisition",
                "Reached 3.72% click-through rate on ad campaigns",
                "Significantly increased social media followers and engagement",
                "Improved brand loyalty and repeat fan interactions"
            ],
            metrics: ["ROAS 6", "€97,209 revenue", "2,859 orders"]
        }
    ];
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="text-center mb-20">
                    ...
                    <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto">
                        A comprehensive approach to growing CSKA Sofia 1948's digital presence, focusing on fan engagement and merchandise sales optimization.
                    </p>
                </div>
...
const ResultsDashboard = () => {
    ...
    const metrics = [
        { key: 'roas', title: 'ROAS Achieved', value: 6, suffix: '', icon: TrendingUp, color: 'text-cyan-400', bgColor: 'bg-cyan-400/10', borderColor: 'border-cyan-400/20' },
        { key: 'revenue', title: 'Revenue Generated', value: '€97,209', suffix: '', icon: DollarSign, color: 'text-sky-400', bgColor: 'bg-sky-400/10', borderColor: 'border-sky-400/20' },
        { key: 'orders', title: 'Orders Completed', value: 2859, suffix: '', icon: ShoppingBag, color: 'text-teal-400', bgColor: 'bg-teal-400/10', borderColor: 'border-teal-400/20' },
        { key: 'ctr', title: 'Click-Through Rate', value: 3.72, suffix: '%', icon: Target, color: 'text-teal-400', bgColor: 'bg-teal-400/10', borderColor: 'border-teal-400/20' }
    ];
    ...
    return (
        <div id="results" ref={dashboardRef} className="py-16">
            ...
            <p className="text-lg text-slate-400 text-center mb-12 max-w-2xl mx-auto">Outstanding performance that significantly transformed CSKA Sofia 1948's digital presence and fan engagement, achieving exceptional ROI.</p>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { title: 'Client', value: 'CSKA Sofia 1948', icon: Building },
                            { title: 'Industry', value: 'Sports & Entertainment', icon: Trophy },
                            { title: 'Period', value: '6 Months', icon: Clock },
                            { title: 'Spend', value: '€16,146', icon: DollarSign },
                            { title: 'Platforms', value: 'Multi-Platform', icon: Globe }
                        ].map((item, index) => {
                    ...
                    <div className="mt-8 p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-cyan-400/50 transition-all duration-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {[
                                { name: 'Social Media Campaigns', icon: Heart },
                                { name: 'Google Ads Management', icon: Target },
                                { name: 'Influencer Partnerships', icon: Users }
                            ].map((service, index) => {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <div>
                            <p className="text-lg text-slate-300 leading-relaxed mb-6">
                                CSKA Sofia 1948 aimed to grow sales and fan engagement by leveraging a comprehensive digital strategy in a highly competitive entertainment market.
                            </p>
                            <ul className="space-y-3">
                                {[
                                    "Low online engagement with younger, tech-savvy audiences",
                                    "Competitive market with many entertainment options",
                                    "Limited visibility in digital channels",
                                    "Need to increase merchandise and ticket sales",
                                    "Challenge to expand fanbase, especially among younger audiences"
                                ].map((challenge, index) => (
                        ...
                        <div className="grid grid-cols-2 gap-4 text-center">
                            <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-cyan-400/50 transition-colors">
                                <span className="block text-2xl font-bold text-cyan-400">Low</span>
                                <span className="text-xs text-slate-400 uppercase">Digital Engagement</span>
                            </div>
                            <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-cyan-400/50 transition-colors">
                                <span className="block text-2xl font-bold text-cyan-400">Limited</span>
                                <span className="text-xs text-slate-400 uppercase">Online Visibility</span>
                            </div>
                            <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-slate-400/50 transition-colors col-span-2">
                                <span className="block text-xl font-bold text-slate-300">Sports Entertainment</span>
                ...
                <div className="mt-16 mb-16">
                    ...
                    <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                        Working in partnership with <span className="text-cyan-400 font-semibold">Marketise Me</span>, we developed a comprehensive sports marketing strategy for CSKA Sofia 1948, focusing on fan engagement and revenue growth through multi-platform digital campaigns:
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            { icon: Heart, title: "Multi-Platform Focus", text: "Concentrated efforts on Facebook, Instagram, YouTube, and Google Ads with engaging sports content to build fan community and reach younger audiences." },
                            { icon: Eye, title: "Behind-the-Scenes Content", text: "Created compelling behind-the-scenes videos and player interviews to form strong emotional bonds with fans and increase engagement." },
                            { icon: Users, title: "Influencer Partnerships", text: "Leveraged influencer partnerships and precise ad targeting to increase campaign efficiency and expand reach to new fan segments." }
                        ].map((item, index) => {
                            const Icon = item.icon;
                            return(
                                <div key={item.title} className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-cyan-400/50 hover:bg-slate-700/50 transition-all duration-300 group" style={{ transform: 'translateZ(0)', willChange: 'transform, border-color', contain: 'layout style paint' }} onMouseEnter={(e) => e.target.style.transform = 'translateZ(0) scale3d(1.05, 1.05, 1)'} onMouseLeave={(e) => e.target.style.transform = 'translateZ(0) scale3d(1, 1, 1)'}>
                                    <div className="flex flex-col items-center text-center">
                                        <div className="p-4 bg-cyan-400/10 rounded-full mb-4 group-hover:bg-cyan-400/20 transition-colors" style={{ transform: 'translateZ(0)', willChange: 'transform, background-color' }} onMouseEnter={(e) => e.target.style.transform = 'translateZ(0) scale3d(1.1, 1.1, 1)'} onMouseLeave={(e) => e.target.style.transform = 'translateZ(0) scale3d(1, 1, 1)'}>
                ...
                <div className="mt-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-cyan-400/50 transition-colors">
                            ...
                            <div className="text-3xl font-bold text-cyan-400 mb-2">Strong</div>
                            <p className="text-slate-300">Fan Connection</p>
                            <div className="mt-4 text-sm text-slate-400">
                                Relatable behind-the-scenes content formed strong emotional bonds with fans, significantly improving engagement and loyalty.
                            </div>
                        </div>
                        <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-sky-400/50 transition-colors">
                            ...
                            <div className="text-3xl font-bold text-sky-400 mb-2">€5.6</div>
                            <p className="text-slate-300">Cost Per Acquisition</p>
                            <div className="mt-4 text-sm text-slate-400">
                                Precise ad targeting and localization improved campaign efficiency, resulting in excellent cost per acquisition rates.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="contact" ref={sectionRef} className="py-24 bg-slate-900/30 quantum-anim relative overflow-hidden w-full">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white">Ready to Score Your Success?</h2>
                    <p className="mt-4 text-lg text-slate-400 max-w-2xl mx-auto">Inspired by CSKA's results? Let's create your winning digital strategy together.</p>
                </div>
...
const CSKACaseStudyPage = () => {
    return (
        <Layout>
            <Head>
                <title>CSKA Sofia 1948 Case Study - Sports Marketing Success | BYLT Media</title>
                <meta name="description" content="Discover how BYLT Media, in collaboration with Marketise Me, helped CSKA Sofia 1948 achieve ROAS 6 and €97,209 revenue through strategic digital marketing campaigns for sports entertainment." />
                <link rel="icon" href="/favicon.ico" />
                <link rel="canonical" href="https://www.byltmedia.com/case-studies-cska" />
...
export default CSKACaseStudyPage;
