...
import { TrendingUp, Users, Target, BarChart, ShoppingBag, DollarSign, Clock, Search, Rocket, Globe, Building, Code, Briefcase, ChevronDown, MoveRight } from 'lucide-react';
...
const CaseStudyHero = () => {
    ...
    const stats = [
        { value: "10,000+", label: "Campaign Reach", icon: Users },
        { value: "15,000+", label: "Total Impressions", icon: Target },
        { value: "900+", label: "Engagements Generated", icon: TrendingUp },
        { value: "2.5%", label: "Click-Through Rate", icon: BarChart }
    ];
        ...
        <section id="home" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden quantum-anim hero-section pt-20">
            ...
            <div className="pointer-events-none absolute inset-0 z-20 overflow-hidden">
                ...
                <div className="absolute inset-0">
                    {[...Array(8)].map((_, i) => (
                        <div
                            key={`bar-${i}`}
                            className="absolute bg-gradient-to-t from-cyan-500 to-sky-400 rounded-t-sm animate-data-bar opacity-70"
                            style={{
                                left: `${10 + i * 10}%`,
                                bottom: '15%',
                                width: '4px',
                                height: `${25 + (i * 20) % 80}px`,
                    ...
                    {[...Array(5)].map((_, i) => (
                        <div
                            key={`bar2-${i}`}
                            className="absolute bg-gradient-to-t from-teal-500 to-emerald-400 rounded-t-sm animate-data-bar-alt opacity-60"
                            style={{
                                left: `${15 + i * 15}%`,
                                top: '20%',
                                width: '3px',
                                height: `${30 + (i * 15) % 60}px`,
                ...
                <div className="absolute top-1/4 left-1/4 w-40 h-40">
                    <div className="relative w-full h-full animate-orbit-slow">
                        <div className="absolute top-0 left-1/2 w-4 h-4 bg-cyan-400 rounded-full transform -translate-x-1/2 animate-pulse shadow-lg shadow-cyan-400/50"></div>
                        <div className="absolute bottom-0 right-0 w-3 h-3 bg-sky-400 rounded-full animate-pulse shadow-lg shadow-sky-400/50" style={{animationDelay: '0.5s'}}></div>
                        <div className="absolute top-1/2 left-0 w-3 h-3 bg-teal-400 rounded-full transform -translate-y-1/2 animate-pulse shadow-lg shadow-teal-400/50" style={{animationDelay: '1s'}}></div>
                        <div className="absolute top-1/4 right-1/4 w-2 h-2 bg-emerald-400 rounded-full animate-pulse shadow-lg shadow-emerald-400/50" style={{animationDelay: '1.5s'}}></div>
                    </div>
                </div>

                <div className="absolute top-1/3 right-1/4 w-32 h-32">
                    <div className="relative w-full h-full animate-orbit-fast">
                        <div className="absolute top-0 left-1/2 w-3 h-3 bg-emerald-400 rounded-full transform -translate-x-1/2 animate-pulse shadow-lg shadow-emerald-400/50" style={{animationDelay: '0.2s'}}></div>
                        <div className="absolute bottom-0 right-0 w-4 h-4 bg-blue-400 rounded-full animate-pulse shadow-lg shadow-blue-400/50" style={{animationDelay: '0.7s'}}></div>
                        <div className="absolute top-1/2 right-0 w-2 h-2 bg-cyan-400 rounded-full transform -translate-y-1/2 animate-pulse shadow-lg shadow-cyan-400/50" style={{animationDelay: '1.2s'}}></div>
                    </div>
                </div>

                <div className="absolute bottom-1/4 left-1/6 w-28 h-28">
                    <div className="relative w-full h-full animate-orbit-reverse">
                        <div className="absolute top-1/2 left-1/2 w-3 h-3 bg-sky-400 rounded-full transform -translate-x-1/2 -translate-y-1/2 animate-pulse shadow-lg shadow-sky-400/50"></div>
                        <div className="absolute top-0 right-0 w-2 h-2 bg-teal-400 rounded-full animate-pulse shadow-lg shadow-teal-400/50" style={{animationDelay: '0.8s'}}></div>
                    </div>
                </div>
            ...
            {/* Removed breadcrumb for cleaner hero header */}
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-6">
                    <span className="block">Automotive Digital</span>
                    <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-sky-500">Engagement</span>
                    <span className="block">for Brickell Group</span>
                </h1>
                
                <p className="max-w-3xl mx-auto text-lg md:text-xl text-slate-300 leading-relaxed mb-12">
                    How BYLT Media, in collaboration with <span className="text-cyan-400 font-semibold">Marketise Me</span>, enhanced Brickell Automotive Group's online presence through strategic social media campaigns, achieving significant engagement growth and improved brand visibility.
                </p>
            ...
            <div onClick={() => document.querySelector('#contact')?.scrollIntoView({ behavior: 'smooth' })} className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2 cursor-pointer group">
                ...
                <span className="text-xs text-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-medium">Get Free Audit</span>
            </div>
        </section>
    );
};
    ...
    const processSteps = [
        {
            ...
            subtitle: "Week 1-2",
            description: "Comprehensive analysis of automotive digital marketing trends and audience engagement patterns.",
            icon: <Search className="w-6 h-6" />,
            details: [
                "Analysed global automotive campaign strategies and best practices",
                "Identified low engagement patterns on existing social media platforms",
                "Studied target audience behaviour and preferences in automotive sector",
                "Conducted competitive analysis within automotive industry",
                "Established baseline metrics and engagement benchmarks"
            ],
            metrics: ["Global campaigns analysed", "Engagement patterns identified", "Baseline metrics established"]
        },
        {
            step: "02",
            title: "Strategy Development", 
            subtitle: "Week 2-3",
            description: "Multi-platform social media strategy focusing on interactive content and targeted campaigns.",
            icon: <Target className="w-6 h-6" />,
            details: [
                "Developed integrated campaigns across Facebook, Instagram, and YouTube",
                "Created interactive content strategy to boost engagement",
                "Designed inquiry-focused ad campaigns for specific car models",
                "Implemented local SEO optimisation for better regional reach",
                "Planned segmented campaigns by language and demographics"
            ],
            metrics: ["3 platform strategy", "Interactive content plan", "Local SEO optimisation"]
        },
        {
            step: "03",
            title: "Campaign Execution",
            subtitle: "Week 3-6", 
            description: "Implementation of targeted social media campaigns with precise audience segmentation.",
            icon: <Rocket className="w-6 h-6" />,
            details: [
                "Launched targeted campaigns across multiple digital channels",
                "Implemented audience segmentation for optimal ad targeting",
                "Created localized content for better regional engagement",
                "Optimized ad targeting for improved message delivery",
                "Deployed interactive content to drive user engagement"
            ],
            metrics: ["Multi-channel campaigns", "Audience segmentation", "Localized content"]
        },
        {
            step: "04",
            title: "Results & Optimisation",
            subtitle: "Week 6-8",
            description: "Continuous monitoring and optimisation leading to exceptional engagement results.",
            icon: <TrendingUp className="w-6 h-6" />,
            details: [
                "Achieved 10,000+ campaign reach across all platforms",
                "Generated 15,000+ total impressions with quality content",
                "Secured 900+ engagements with 2.5% click-through rate",
                "Maintained cost-effective €0.50 cost per engagement",
                "Improved brand visibility and customer interaction rates"
            ],
            metrics: ["10K+ reach", "900+ engagements", "2.5% CTR achieved"]
        }
    ];
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="text-center mb-20">
                    ...
                    <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto">
                        A comprehensive approach to automotive social media marketing and engagement optimization for Brickell Automotive Group, delivered through our strategic partnership with <span className="text-cyan-400 font-semibold">Marketise Me</span>.
                    </p>
                </div>
...
const ResultsDashboard = () => {
    ...
    const metrics = [
        { key: 'reach', title: 'Campaign Reach', value: 10000, suffix: '+', icon: Users, color: 'text-cyan-400', bgColor: 'bg-cyan-400/10', borderColor: 'border-cyan-400/20' },
        { key: 'impressions', title: 'Total Impressions', value: 15000, suffix: '+', icon: Target, color: 'text-sky-400', bgColor: 'bg-sky-400/10', borderColor: 'border-sky-400/20' },
        { key: 'engagements', title: 'Engagements Generated', value: 900, suffix: '+', icon: TrendingUp, color: 'text-teal-400', bgColor: 'bg-teal-400/10', borderColor: 'border-teal-400/20' },
        { key: 'ctr', title: 'Click-Through Rate', value: 2.5, suffix: '%', icon: BarChart, color: 'text-emerald-400', bgColor: 'bg-emerald-400/10', borderColor: 'border-emerald-400/20' }
    ];
    ...
    return (
        <div id="results" ref={dashboardRef} className="py-16">
            ...
            <p className="text-lg text-slate-400 text-center mb-12 max-w-2xl mx-auto">Exceptional social media performance that significantly boosted Brickell Automotive Group's online engagement and brand visibility.</p>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        {[
                            { title: 'Client', value: 'Brickell Automotive', icon: Building },
                            { title: 'Industry', value: 'Automotive', icon: ShoppingBag },
                            { title: 'Duration', value: '8 Weeks', icon: Clock },
                            { title: 'Campaign Focus', value: 'Social Engagement', icon: Users },
                            { title: 'Platforms', value: 'Multi-Channel', icon: Globe }
                        ].map((item, index) => {
                    ...
                    <div className="mt-8 p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-cyan-400/50 transition-all duration-300">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {[
                                ...
                                { name: 'Content Creation & Strategy', icon: BarChart },
                                { name: 'Local SEO Optimization', icon: Code }
                            ].map((service, index) => {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <div>
                            <p className="text-lg text-slate-300 leading-relaxed mb-6">
                                Brickell Automotive Group needed to increase online engagement and boost the number of inquiries for car models within the group through targeted social media campaigns.
                            </p>
                            <ul className="space-y-3">
                                {[
                                    "Low engagement rates on existing social media platforms",
                                    "Insufficient reach to target automotive audiences",
                                    "Need to increase meaningful interactions on social posts",
                                    "Limited brand visibility in competitive automotive market",
                                    "Requirement for cost-effective customer acquisition strategies"
                                ].map((challenge, index) => (
                        ...
                        <div className="grid grid-cols-2 gap-4 text-center">
                            ...
                            <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-red-400/50 transition-colors">
                                <span className="block text-2xl font-bold text-red-400">Limited</span>
                                <span className="text-xs text-slate-400 uppercase">Reach</span>
                            </div>
                            <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-slate-400/50 transition-colors col-span-2">
                                <span className="block text-xl font-bold text-slate-300">Automotive Industry</span>
                                <span className="text-xs text-slate-400 uppercase">Market Focus</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-16 mb-16">
                    ...
                    <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                        Working through our strategic partnership with <span className="text-cyan-400 font-semibold">Marketise Me</span>, we delivered a comprehensive digital marketing solution:
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            { icon: Target, title: "Multi-Platform Strategy", text: "Developed integrated campaigns across Facebook, Instagram, and YouTube with interactive content designed to boost automotive audience engagement." },
                            { icon: BarChart, title: "Targeted Content Creation", text: "Created inquiry-focused ad campaigns for specific car models with localized content and precise audience segmentation for better reach." },
                            { icon: Code, title: "SEO & Optimisation", text: "Implemented local SEO optimisation and cost-effective targeting strategies to improve brand visibility and customer acquisition." }
                        ].map((item, index) => {
                            const Icon = item.icon;
                            return(
                                <div key={item.title} className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-cyan-400/50 hover:bg-slate-700/50 transition-all duration-300 hover:scale-105 group">
                ...
                {/* Additional Metrics */}
                <div className="mt-16">
                    <h2 className="text-3xl font-bold text-white mb-6 border-l-4 border-cyan-400 pl-4">Key Performance Indicators</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-cyan-400/50 transition-colors">
                            ...
                            <div className="text-3xl font-bold text-cyan-400 mb-2">€0.50</div>
                            <p className="text-slate-300">Cost per Engagement</p>
                            <div className="mt-4 text-sm text-slate-400">
                                Achieved highly cost-effective engagement rates, ensuring optimal ROI for the automotive marketing campaign.
                            </div>
                        </div>
                        <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl hover:border-sky-400/50 transition-colors">
                            <h3 className="text-xl font-bold text-white mb-4">Engagement Quality</h3>
                            <div className="text-3xl font-bold text-sky-400 mb-2">High</div>
                            <p className="text-slate-300">Interaction Quality</p>
                            <div className="mt-4 text-sm text-slate-400">
                                Generated meaningful interactions and inquiries, leading to improved brand visibility and customer interest.
                            </div>
                        </div>
                    </div>
                </div>
...
const BrickellCaseStudyPage = () => {
    return (
        <Layout>
            <Head>
                <title>Brickell Automotive Group Case Study - Social Media Success | BYLT Media</title>
                <meta name="description" content="Discover how BYLT Media, in collaboration with Marketise Me, helped Brickell Automotive Group achieve 10,000+ reach and 900+ engagements through strategic social media campaigns." />
                <link rel="icon" href="/favicon.ico" />
                <link rel="canonical" href="https://www.byltmedia.com/case-studies-brickell" />
...
export default BrickellCaseStudyPage;
