        ...
        >
            <div className="max-w-content mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <InfiniteMovingCards
                    ...
                    className="py-4"
                    renderItem={(item) => (
                        <div className="relative w-55 h-50 bg-linear-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-cyan-500/20 group flex flex-col items-center justify-center gap-4 p-6"
