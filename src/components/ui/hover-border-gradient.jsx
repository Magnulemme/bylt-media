...
export function HoverBorderGradient({
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex rounded-full border  content-center bg-[#020617]/20 hover:bg-[#020617]/10 transition duration-500 dark:bg-white/20 items-center flex-col flex-nowrap gap-10 h-min justify-center overflow-visible p-px decoration-clone w-fit",
        containerClassName
      )}
      {...props}>
      <div
